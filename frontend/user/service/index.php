...
<center>
  <div class="row">
    <div class="column"><div class="card" >
        <img src="img/cleaning.jpg" alt="Cleaning" style="width:100%">
        <h2>Cleaning</h2>
    ...
    <div class="column"><div class="card" >
      <img src="img/dentures.jpg" alt="Dentures" style="width:100%">
    <h2>Dentures</h2>
    <p class="price2">Estimated Price</p>
    ...
    <div class="column"><div class="card" >
      <img src="img/filling.jpg" alt="Filling" style="width:100%">
   <h2>Tooth Filling</h2>
   <p class="price2">Estimated Price</p>
  ...
  <div class="row">
    <div class="column"><div class="card" >
      <img src="img/orthodontics.jpg" alt="Orthodontic" style="width:100%">
    <h2>Orthodontic Braces</h2>
    <p class="price2">Estimated Price</p>
    <p class="price2">₱35,000.00</p>
    <p class="braces"> (DP 5,000) Treatment of irregularities in the teeth and jaws, including the use of braces.</p>
      </div>
    </div>
    <div class="column"><div class="card" >
      <img src="img/extraction.jpg" alt="Extraction" style="width:100%">
    ...
    <div class="column"><div class="card" >
        <img src="img/whitening.jpg" alt="Whitening" style="width:100%">
        <h2>Whitening</h2>
        <p class="price2">Estimated Price</p>
