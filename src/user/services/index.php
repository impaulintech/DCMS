...
<body>
  ...
  <div class="background">
    ...
    <div class="flex-card">
      <div class="cards">
        <img src="../assets/images/cleaning.jpg" alt="Cleaning" style="width:100%; height: 200px;">
        <h2>Cleaning</h2>
      ...
      <div class="cards">
        <img src="../assets/images/dentures.jpg" alt="Dentures" style="width:100%; height: 200px;">
        <h2>Dentures</h2>
        <p class="price2">Estimated Price</p>
      ...
      <div class="cards">
        <img src="../assets/images/filling.jpg" alt="Filling" style="width:100%; height: 200px;">
        <h2>Tooth Filling</h2>
        <p class="price2">Estimated Price</p>
      ...
      <div class="cards">
        <img src="../assets/images/orthodontics.jpg" alt="Orthodontic" style="width:100%; height: 200px;">
      ...
      <div class="cards">
        <img src="../assets/images/extraction.jpg" alt="Extraction" style="width:100%; height: 200px;">
      ...
      <div class="cards">
        <img src="../assets/images/whitening.jpg" alt="Whitening" style="width:100%; height: 200px;">
        <h2>Whitening</h2>
        <p class="price2">Estimated Price</p>
